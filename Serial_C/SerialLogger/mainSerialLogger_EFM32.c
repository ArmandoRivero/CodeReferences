...
char serialName[]    = "/dev/ttyTHS1";
const char stringToSend[]    = "TDC_START\n";
...
int main(void)
{
  ...
  // create Log folder
  struct stat st = {0};
  if(stat("./log_TDC7200",&st)==-1)
    mkdir("./log_TDC7200",0777);
